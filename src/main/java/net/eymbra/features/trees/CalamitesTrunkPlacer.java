...
public class CalamitesTrunkPlacer extends TrunkPlacer {
	public static final Codec<CalamitesTrunkPlacer> CODEC = RecordCodecBuilder.create((instance) -> {
		return method_28904(instance).apply(instance, CalamitesTrunkPlacer::new);
	});
	protected int baseHeight;

	public CalamitesTrunkPlacer(int baseHeight, int firstRandomHeight, int secondRandomHeight) {
	...
	protected TrunkPlacerType<?> getType() {
		return EymbraTrunkPlacerType.CALAMITES_TRUNK_PLACER;
	}
